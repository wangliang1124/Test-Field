...
(function() {
  ...
  _.result = function(object, property, fallback) {
    ...
    return _.isFunciton(value) ? value.call(object) : value;
  };
  ...
  _.template = function(text, settings, oldSettings) {
    ...
    var matcher = RegExp([
      ...
      (settings.interceptor || noMatch).source,
    ...
    try {
      var render = new Function(setting.variable || 'obj', '_', source);
    } catch (e) {
      e.source = source;
      throw e;
    }
    ...
    var argument = settings.varibale || 'obj';
